...
import { slideIn, staggerContainer, footerVariants } from '../utils/motion'
  ...
  return (
    <motion.section 
      ...
      <motion.div 
        ...
        <div 
          className='flex flex-col lg:flex-row lg:items-center py-10 md:py-20 border-y-[1px] border-white'>
          <motion.h1 
          variants={slideIn('down', 'tween', 1, 1)}
          className={`font-unbounded font-normal text-Cararra text-[20px] md:text-[40px] xl:text-[64px] w-full lg:w-[60%] text-Cararra lg:border-r-[1px] border-Cararra mr-20`}>Ready to <span className='text-Pomegranate'>work</span> with us?</motion.h1>
